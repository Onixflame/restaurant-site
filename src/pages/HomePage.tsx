...
export function HomePage() {
  ...
  return <PageShell>
    ...
    <section className="story-teaser reveal"><div className="story-teaser-copy"><div className="history-mark">1728</div><div className="kicker">From house to restaurant</div><h2 className="display">The Black Stone</h2><p className="copy">A glass merchant's residence, a nineteenth-century salon, a shuttered cellar and a rediscovered oak hearth. ONIX carries the history of the building as a thread through the dining room.</p><Link className="text-link" to="/story">Explore five chapters of the house</Link></div><div className="story-teaser-media image-reveal"><div className="story-caption">Malá Strana · Prague 1</div></div></section>
